...
<div style="background-color: #fff3cd; border: 1px solid #ffc107; border-radius: 4px; padding: 15px; margin: 20px auto; max-width: 900px; text-align: center;">
<strong>⏰ Service Hours Notice:</strong> Newly added events will only be posted to Social Media during service hours: 08:30-20:30 UTC.<br>You can still edit event details here, but it will not trigger any 'new event' posts while out-of-hours.
</div>
